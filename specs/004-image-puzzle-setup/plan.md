...
**Output**: `tasks.md` (NOT generated by /speckit.plan)

**Note**: Use `/speckit.tasks` command after this plan is reviewed to generate detailed task breakdown.
...
2. **Phase 0 Research**: Execute research tasks in Phase 0, document findings in `research.md`
3. **Phase 1 Design**: Generate data models and contracts based on research decisions
4. **Generate Tasks**: Run `/speckit.tasks` to create detailed task breakdown in `tasks.md`
5. **Execute Implementation**: Follow TDD workflow in task order, maintain test coverage >80%
