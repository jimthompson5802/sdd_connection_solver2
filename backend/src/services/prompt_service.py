...
class PromptTemplateService:
    ...
    def _load_base_prompt(self) -> str:
        ...
        return (
            ...
            "- Consider wordplay, categories, and subtle relationships. here are some examples\n"
            "  - [BASS, FLOUNDER, SALMON, TROUT] - Types of fish\n"
            "  - [NATURAL, HARVARD, LEMON, CRIMINAL] - _____ Law\n"
            "  - [COLLAR, BUTTON, SLEAVE, POCKET] - parts of a shirt\n"
            "  - [BIRD, FALLING, SOLO, WILL] - Free _____\n"
            "- Use ONLY words from the AVAILABLE WORDS list below\n"
            "- When comparing two word groups, the order of words does NOT matter, "
            "  for example, [CAT, DOG, MOUSE, HORSE] is the same word group as [DOG, CAT, HORSE, MOUSE]\n"
            ...
            "- Your answer is INVALID if the four word group matches a group in PREVIOUS INCORRECT GROUP GUESSES, "
            "in this case come up with a new group.\n"
