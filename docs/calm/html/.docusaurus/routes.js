    ...
    routes: [
      {
        ...
        routes: [
          {
            path: '/',
            component: ComponentCreator('/', 'c72'),
            routes: [
              {
                path: '/flows/game-history-retrieval-flow',
                component: ComponentCreator('/flows/game-history-retrieval-flow', 'ecc'),
                exact: true,
                sidebar: "docs"
              },
              {
                path: '/flows/game-results-recording-flow',
                component: ComponentCreator('/flows/game-results-recording-flow', 'd82'),
                exact: true,
                sidebar: "docs"
              },
              {
              ...
              {
                path: '/nodes/game-results-database',
                component: ComponentCreator('/nodes/game-results-database', '4ef'),
                exact: true,
                sidebar: "docs"
              },
              {
              ...
              {
                path: '/relationships/backend-to-database-connection',
                component: ComponentCreator('/relationships/backend-to-database-connection', '396'),
                exact: true,
                sidebar: "docs"
              },
              {
